            ...
            {quests.map((quest) => {
              ...
              return (
                <GlassCard key={quest.id} className="p-4">
                  ...
                  {expanded && (
                    <div className="mt-4 rounded-[14px] border border-sk-violetHi/15 bg-sk-violetHi/10 px-3.5 py-3">
                      <div className="font-mono text-[9.5px] tracking-[1px] text-sk-text3">ТЕКУЩИЙ ЭТАП</div>
                      <div className="mt-1 font-ui text-sm font-semibold text-sk-text">{quest.step}</div>
                      <div className="mt-2 font-ui text-xs leading-relaxed text-sk-text2">
                        Заверши доступные точки маршрута на карте, чтобы продвинуть прогресс и получить награду квеста.
                      </div>
                    </div>
                  )}
